...
export const EXAMPLE_CIRCUITS: ExampleCircuit[] = [
  ...
  {
    id: 'm16-hbridge',
    name: 'H-Bridge Motor Control',
    description: 'Two 9V batteries, four resistors, and one motor arranged as an H-bridge starter topology',
    components: [
      {
        id: 'example-m16-hbridge-battery-a',
        type: 'battery',
        anchorPos: midpoint(topNodePos(20, 2), topNodePos(22, 2)),
        rotationY: 0,
        pins: [
      ...
      {
        id: 'example-m16-hbridge-battery-b',
        type: 'battery',
        anchorPos: midpoint(topNodePos(24, 2), topNodePos(26, 2)),
        rotationY: 0,
        pins: [
          { name: 'pos', nodeId: topNodeId(24, 2) },
          { name: 'neg', nodeId: topNodeId(26, 2) },
        ],
        props: {},
      },
      {
        id: 'example-m16-hbridge-r1',
        type: 'resistor',
        anchorPos: midpoint(topNodePos(20, 2), topNodePos(30, 2)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(20, 2) },
          { name: 'p2', nodeId: topNodeId(30, 2) },
      ...
      {
        id: 'example-m16-hbridge-r2',
        type: 'resistor',
        anchorPos: midpoint(topNodePos(22, 2), topNodePos(32, 2)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(22, 2) },
          { name: 'p2', nodeId: topNodeId(32, 2) },
        ],
        props: { resistance: 220 },
      },
      {
        id: 'example-m16-hbridge-r3',
        type: 'resistor',
        anchorPos: midpoint(topNodePos(24, 2), topNodePos(32, 2)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(24, 2) },
          { name: 'p2', nodeId: topNodeId(32, 2) },
        ],
        props: { resistance: 220 },
      },
      {
        id: 'example-m16-hbridge-r4',
        type: 'resistor',
        anchorPos: midpoint(topNodePos(26, 2), topNodePos(30, 2)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(26, 2) },
          { name: 'p2', nodeId: topNodeId(30, 2) },
        ],
        props: { resistance: 220 },
      },
      {
        id: 'example-m16-hbridge-motor',
        type: 'motor',
        anchorPos: midpoint(topNodePos(30, 2), topNodePos(32, 2)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(30, 2) },
          { name: 'p2', nodeId: topNodeId(32, 2) },
        ],
        props: { speed: 1000 },
      },
  ...
  },
  {
    ...
    name: 'Arduino Blink Starter',
    description: 'Arduino Uno with LED + resistor driven from pin 13 using Blink logic',
    components: [
      {
        id: 'example-m17-arduino',
        type: 'arduino',
        anchorPos: midpoint(topNodePos(10, 2), topNodePos(23, 2)),
        rotationY: 0,
        pins: [
          { name: 'd13', nodeId: topNodeId(26, 2) },
          { name: 'd12', nodeId: topNodeId(18, 2) },
          { name: 'd11', nodeId: topNodeId(17, 2) },
          { name: 'd10', nodeId: topNodeId(16, 2) },
          { name: 'd9', nodeId: topNodeId(15, 2) },
          ...
          { name: 'a4', nodeId: topNodeId(1, 2) },
          { name: 'a5', nodeId: topNodeId(0, 2) },
          { name: 'vcc', nodeId: topNodeId(35, 2) },
          { name: 'gnd', nodeId: topNodeId(36, 2) },
        ],
        props: {},
      },
      {
        id: 'example-m17-arduino-resistor',
        type: 'resistor',
        anchorPos: midpoint(topNodePos(26, 2), topNodePos(27, 2)),
        rotationY: 0,
        pins: [
    ...
    wires: [
      { id: 'example-m17-arduino-w1', fromNodeId: topNodeId(26, 2), toNodeId: topNodeId(27, 2), color: '#22aa22' },
      { id: 'example-m17-arduino-w2', fromNodeId: topNodeId(27, 2), toNodeId: topNodeId(28, 2), color: '#22aa22' },
      { id: 'example-m17-arduino-w3', fromNodeId: topNodeId(29, 2), toNodeId: topNodeId(36, 2), color: '#333333' },
      { id: 'example-m17-arduino-vcc', fromNodeId: topNodeId(35, 2), toNodeId: railNode('tp', 1), color: '#cc4444' },
      { id: 'example-m17-arduino-gnd', fromNodeId: topNodeId(36, 2), toNodeId: railNode('tn', 1), color: '#333333' },
    ],
  },
  {
    id: 'm18-arduino-pot',
    name: 'Arduino + Potentiometer',
    description: 'Arduino Uno potentiometer divider with wiper fed to analog input A0',
    components: [
      {
        id: 'example-m18-arduino',
        type: 'arduino',
        anchorPos: midpoint(topNodePos(10, 2), topNodePos(23, 2)),
        rotationY: 0,
        pins: [
      ...
      },
      {
        id: 'example-m18-pot',
        type: 'potentiometer',
        anchorPos: midpoint(topNodePos(15, 2), topNodePos(17, 2)),
        rotationY: 0,
        pins: [
          { name: 'a', nodeId: topNodeId(15, 2) },
          { name: 'wiper', nodeId: topNodeId(16, 2) },
          { name: 'b', nodeId: topNodeId(17, 2) },
        ],
        props: { resistance: 10000, wiper: 0.5 },
      },
    ],
    wires: [
      { id: 'example-m18-pot-vcc', fromNodeId: topNodeId(35, 2), toNodeId: railNode('tp', 1), color: '#cc4444' },
      { id: 'example-m18-pot-gnd', fromNodeId: topNodeId(36, 2), toNodeId: railNode('tn', 1), color: '#333333' },
      { id: 'example-m18-pot-a', fromNodeId: topNodeId(15, 2), toNodeId: topNodeId(35, 2), color: '#cc4444' },
      { id: 'example-m18-pot-b', fromNodeId: topNodeId(17, 2), toNodeId: topNodeId(36, 2), color: '#333333' },
      { id: 'example-m18-pot-a0', fromNodeId: topNodeId(16, 2), toNodeId: topNodeId(5, 2), color: '#22aa22' },
    ],
  },
  {
    id: 'm19-pwm-led',
    name: 'PWM LED Brightness',
    description: 'Arduino Uno pin 9 with analogWrite driving an LED on resistor',
    components: [
      {
        id: 'example-m19-arduino',
        type: 'arduino',
        anchorPos: midpoint(topNodePos(10, 2), topNodePos(23, 2)),
        rotationY: 0,
        pins: [
      ...
      {
        id: 'example-m19-pwm-led',
        type: 'led',
        anchorPos: midpoint(topNodePos(17, 2), topNodePos(18, 2)),
        rotationY: 0,
        pins: [
          { name: 'anode', nodeId: topNodeId(17, 2) },
          { name: 'cathode', nodeId: topNodeId(18, 2) },
        ],
        props: { color: 'red' },
      },
    ],
    wires: [
      { id: 'example-m19-pwm-w1', fromNodeId: topNodeId(15, 2), toNodeId: topNodeId(16, 2), color: '#22aa22' },
      { id: 'example-m19-pwm-w2', fromNodeId: topNodeId(16, 2), toNodeId: topNodeId(17, 2), color: '#22aa22' },
      { id: 'example-m19-pwm-w3', fromNodeId: topNodeId(18, 2), toNodeId: topNodeId(36, 2), color: '#333333' },
      { id: 'example-m19-pwm-vcc', fromNodeId: topNodeId(35, 2), toNodeId: railNode('tp', 1), color: '#cc4444' },
      { id: 'example-m19-pwm-gnd', fromNodeId: topNodeId(36, 2), toNodeId: railNode('tn', 1), color: '#333333' },
    ],
  },
  {
    id: 'm20-logic-gates',
    name: 'NPN Inverter (NOT Gate)',
    description: 'NPN transistor inverts a switch input and drives LED output',
    components: [
      {
        id: 'example-m20-inverter-battery',
        type: 'battery',
        anchorPos: midpoint(topNodePos(18, 0), topNodePos(20, 0)),
        rotationY: 0,
        pins: [
          { name: 'pos', nodeId: topNodeId(18, 0) },
          { name: 'neg', nodeId: topNodeId(20, 0) },
        ],
        props: {},
      },
      {
        id: 'example-m20-inverter-switch',
        type: 'tactileSwitch',
        anchorPos: midpoint(topNodePos(18, 0), topNodePos(22, 0)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(18, 0) },
          { name: 'p2', nodeId: topNodeId(22, 0) },
        ],
        props: { closed: 0 },
      },
      {
        id: 'example-m20-inverter-base-r',
        type: 'resistor',
        anchorPos: midpoint(topNodePos(22, 0), topNodePos(24, 0)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(22, 0) },
          { name: 'p2', nodeId: topNodeId(24, 0) },
        ],
        props: { resistance: 10000 },
      },
      {
        id: 'example-m20-inverter-transistor',
        type: 'bjt',
        anchorPos: midpoint(topNodePos(24, 0), topNodePos(26, 0)),
        rotationY: 0,
        pins: [
          { name: 'base', nodeId: topNodeId(24, 0) },
          { name: 'collector', nodeId: topNodeId(26, 0) },
          { name: 'emitter', nodeId: topNodeId(20, 0) },
        ],
        props: {},
      },
      {
        id: 'example-m20-inverter-collector-r',
        type: 'resistor',
        anchorPos: midpoint(topNodePos(18, 0), topNodePos(26, 0)),
        rotationY: 0,
        pins: [
          { name: 'p1', nodeId: topNodeId(18, 0) },
          { name: 'p2', nodeId: topNodeId(26, 0) },
      ...
      {
        id: 'example-m20-inverter-led',
        type: 'led',
        anchorPos: midpoint(topNodePos(26, 0), topNodePos(28, 0)),
        rotationY: 0,
        pins: [
          { name: 'anode', nodeId: topNodeId(26, 0) },
          { name: 'cathode', nodeId: topNodeId(28, 0) },
        ],
        props: { color: 'red' },
      },
    ],
    wires: [
      { id: 'example-m20-inverter-w1', fromNodeId: topNodeId(28, 0), toNodeId: topNodeId(20, 0), color: '#333333' },
    ],
  },
];
